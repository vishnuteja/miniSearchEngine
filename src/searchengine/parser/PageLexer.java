...
public class PageLexer<E> implements Iterator<E> {
			...
			
	{
		   ...
		   //EOF NUM WRD STR  <   >   =   /   -   !   A  HRF IMG SRC ALT frame iframe
			{-1,  3,  1,  1,  2,  0,  0,  0,  0,  0,  0,  0,  0,  0,  5,  5,  5},  // state 0
			{-1,  3,  1,  1,  2,  0,  0,  0,  0,  0,  0,  0,  0,  0,  5,  5,  5},  // state 1
			{-1,  5,  5,  5,  5,  6,  5,  5,  5,  5,  4,  5,  5,  0,  5, 13, 14},  // state 2
			{-1,  3,  1,  1,  2,  0,  0,  0,  0,  0,  0,  0,  0,  0,  5,  5,  5},  // state 3
			{-1,  5,  5,  5,  5,  6,  5,  5,  5,  5,  5,  7,  5,  0,  5,  5,  5},  // state 4
			{-1,  5,  5,  5,  5,  6,  5,  5,  5,  5,  5,  5,  5,  11,  5,  5,  5},  // state 5
			{-1,  3,  1,  1,  2,  0,  0,  0,  0,  0,  0,  0,  0,  0,  5,  5,  5},  // state 6
			{-1,  5,  5,  5,  5,  5,  8,  5,  5,  5,  5,  5,  5,  0,  5,  5,  5},  // state 7
			{-1,  5,  5,  9,  5,  5,  5,  5,  5,  5,  5,  5,  5,  0,  5,  5,  5},  // state 8
			{-1,  5,  5,  5,  5,  6,  5,  5,  5,  5,  5,  5,  5,  0,  5,  5,  5},  // state 9
			{-1,  5,  5,  5,  5,  6,  5,  5,  5,  5,  5,  5,  5,  0, 12,  5,  5},  //state 10
			{-1,  5,  5,  10,  5,  6,  11,  5,  5,  5,  5,  5,  5,  0,  5,  5,  5},  //state 11
			{-1,  5,  5,  10,  5,  6,  12,  5,  5,  5,  5,  5,  5,  0,  5,  5,  5},  //state 12
			{-1,  5,  5,  10,  5,  6,  13,  5,  5,  5,  5,  5,  5,  7,  5,  5,  5},  //state 13
			{-1,  5,  5,  10,  5,  6,  14,  5,  5,  5,  5,  5,  5,  7,  5,  5,  5},  //state 14
